    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Status__C8EE20636B7F4021", x => x.StatusId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__1788CC4CF450A1FA", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TodoTask__7C6949B102D6F9DC", x => x.TaskId);
                    table.ForeignKey(
                        name: "FK__TodoTasks__Statu__47DBAE45",
                        column: x => x.StatusId,
                        principalTable: "Status",
                        principalColumn: "StatusId");
                    table.ForeignKey(
                        name: "FK__TodoTasks__UserI__46E78A0C",
                        column: x => x.UserId,
